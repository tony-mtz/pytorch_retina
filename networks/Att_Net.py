...
class Att_Net(nn.Module):
    def __init__(self, input_size):
        ...
        self.bn = nn.BatchNorm2d(self.chn*4)
        
        
        self.up2 = nn.Upsample(scale_factor=2)
        self.up2_1 = bn_relu(self.chn*4,self.chn*2, 3,1,1)
...
#         self.bn2 = nn.BatchNorm2d(64)
        ...
        self.up1_1 = bn_relu(self.chn*2,self.chn,3,1,1)
#         self.up1m = MultiHeadAttention_(32,32,12,12,4)
#         self.bn3 = nn.BatchNorm2d(32)        
        self.out = nn.Conv2d(self.chn,2,3,1,1)      
